...
crowdthreshold[P_GREENMEANDER] = 5;
crowdthreshold[P_REDSCATTER] = 1;
...
crowdbirthlimit[P_GREENMEANDER] = 7;
crowdbirthlimit[P_REDSCATTER] = 7;
...
metabolismspeed[P_GRASS] =  PMETAB_SLOW;
...
germinationbase[P_REDSCATTER] =  35;
germinationbase[P_REDHARDY] =  3;
germinationbase[P_BLUEWAVE] =  25;
germinationbase[P_BLUEVERTICAL] =  25;
germinationbase[P_GREENDELICATE] =  10;
germinationbase[P_GREENHORIZONTAL] =  25;
germinationbase[P_GRASS] =  20;
...
seedcost[P_ITCHGRASS] = 0;
seedcost[P_STRAWBERRY] = 2;
seedcost[P_BLUEBERRY] = 2;
seedcost[P_CORNFLOWER] = 1;
seedcost[P_CLIANTRO] = 1;
seedcost[P_CLOVER] = 1;
seedcost[P_DANDELION] = 0;
seedcost[P_ONION] = 1;
seedcost[P_MUSHROOM] = 1;
seedcost[P_BLUEHEDGE] = 3;
seedcost[P_GREENTOMATO] = 3;
seedcost[P_HEDGE] = 3;
seedcost[P_GRASS] = 1;
seedcost[P_WEED] = 1;
seedcost[P_TOMATO] = 3;
seedcost[P_WATERMELON] = 5;
seedcost[P_EGGPLANT] = 4;
seedcost[P_PEPPER] = 4;
...
poopvalue[P_ITCHGRASS] = 1;
poopvalue[P_STRAWBERRY] = 1;
poopvalue[P_BLUEBERRY] = 1;
poopvalue[P_CORNFLOWER] = 1;
poopvalue[P_CLIANTRO] = 1;
poopvalue[P_CLOVER] = 4;
poopvalue[P_DANDELION] = 1;
poopvalue[P_ONION] = 2;
poopvalue[P_MUSHROOM] = 2;
poopvalue[P_BLUEHEDGE] = 1;
poopvalue[P_GREENTOMATO] = 4;
poopvalue[P_HEDGE] = 3;
poopvalue[P_GRASS] = 5;
poopvalue[P_WEED] = 2;
...
plantseason[2,8]=1;plantseason[2,9]=0;plantseason[2,10]=0;plantseason[2,11]=0;
// Plant 3 (Blue Round)
plantseason[3,0]=0;plantseason[3,1]=0;plantseason[3,2]=0;plantseason[3,3]=1;
plantseason[3,4]=2;plantseason[3,5]=2;plantseason[3,6]=3;plantseason[3,7]=4;
plantseason[3,8]=4;plantseason[3,9]=3;plantseason[3,10]=2;plantseason[3,11]=1;
