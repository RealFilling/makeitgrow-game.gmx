if (global.demomode == false) {
  ...
  addtoinvent(INVENTTYPE_BUILDING,BLDG_PIPEPUMP,1);
  //addtoinvent(INVENTTYPE_BUILDING,BLDG_COOP,1);
  //addtoinvent(INVENTTYPE_BUILDING,BLDG_FENCEGATECLOSED,1);
  addtoinvent(INVENTTYPE_BUILDING,BLDG_SMALLCOOP,1);
  addtoinvent(INVENTTYPE_BUILDING,BLDG_MEDCOOP,1);
  addtoinvent(INVENTTYPE_BUILDING,BLDG_BIGCOOP,1);
  addtoinvent(INVENTTYPE_BUILDING,BLDG_WOODFENCE,1);
  addtoinvent(INVENTTYPE_BUILDING,BLDG_WIREFENCE,1);
